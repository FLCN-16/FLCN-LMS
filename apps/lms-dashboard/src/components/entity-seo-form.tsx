...
import {
  ...
  TabsList,
  TabsTrigger,
} from "@flcn-lms/ui/components/tabs"
import { Textarea } from "@flcn-lms/ui/components/textarea"

interface EntitySeoFormProps {
  entityLabel: string
  defaultValues?: {
...
export function EntitySeoForm({
  ...
  const previewTitle =
    defaultValues?.seoTitle || `Optimized ${entityLabel} page title`
          ...
          <TabsContent value="metadata">
            <FieldGroup>
              <Field>
                ...
                <Input
                  name="seoTitle"
                  placeholder={`${entityLabel} | FLCN LMS`}
              ...
              <Field>
                ...
                <Textarea
                  name="seoDescription"
                  rows={4}
                  placeholder={`Search-friendly summary for this ${entityLabel.toLowerCase()} page.`}
          ...
          <TabsContent value="keywords">
            <FieldGroup>
              <Field>
                ...
                <Input
                  name="seoKeywords"
                  placeholder={`${entityLabel.toLowerCase()}, learning, online education`}
                  defaultValue={previewKeywords}
                />
                <FieldDescription>
