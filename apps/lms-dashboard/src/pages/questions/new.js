                ...
                <FieldGroup>
                  <div className="grid grid-cols-2 gap-4">
                    <Field>
                      ...
                      <NativeSelect name="type" defaultValue="MCQ" required className="w-full">
              ...
              <CardContent className="pt-4">
                <FieldGroup>
                  <Field>
                    ...
                    <Input name="positiveMarks" type="number" step="0.5" min="0" defaultValue={4}/>
                    <FieldDescription>Awarded for correct</FieldDescription>
                  </Field>
                  <Field>
                    <FieldLabel>Incorrect (−)</FieldLabel>
                    <Input name="negativeMarks" type="number" step="0.5" min="0" defaultValue={1}/>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4 pt-4">
              <Field>
                ...
                <RichEditor name="content" placeholder="Enter question text — LaTeX supported via formula module" minHeight={140} mode="full"/>
              </Field>
              <Separator />
              <Field>
                <FieldLabel>
                ...
                <RichEditor name="explanation" placeholder="Step-by-step solution shown after submission" minHeight={100} mode="full"/>
              </Field>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="pt-4">
              <FieldGroup>
                ...
                : "border-border text-transparent hover:border-muted-foreground"}`} title={opt.isCorrect ? "Mark as incorrect" : "Mark as correct"}>
