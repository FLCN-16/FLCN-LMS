...
import { Award, CreditCard, Key, Package, ArrowRight, TrendingUp, Users, Zap, } from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => {
            ...
            return (<Link key={stat.label} to={stat.href} className="group rounded-lg border border-border p-6 transition-all duration-200 hover:border-amber-400/40 hover:bg-card/80 active:scale-95">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {navItems.map((item) => {
            ...
            return (<Link key={item.href} to={item.href} className={`group relative rounded-lg border p-5 transition-all duration-300 cursor-pointer active:scale-95 ${colors.border} ${colors.hover}`}>
