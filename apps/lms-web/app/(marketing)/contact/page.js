"use client";
import { Clock01Icon, Location01Icon, Mail01Icon, SmartPhone01Icon, } from "@hugeicons/core-free-icons";
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <Input id="subject" name="subject" type="text" placeholder="What is this about?" value={formData.subject} onChange={handleChange} required/>
                </div>
              </div>
              ...
              {submitStatus === "success" && (<div className="rounded-md bg-green-50 p-4 text-green-800 dark:bg-green-900 dark:text-green-200">
                  Thank you! Your message has been sent successfully. We'll get
                  back to you soon.
                </div>)}

              {submitStatus === "error" && (<div className="rounded-md bg-red-50 p-4 text-red-800 dark:bg-red-900 dark:text-red-200">
                  {errorMessage ||
                "An error occurred while sending your message. Please try again."}
                </div>)}

              <Button type="submit" disabled={submitStatus === "loading"} className="w-full md:w-auto">
