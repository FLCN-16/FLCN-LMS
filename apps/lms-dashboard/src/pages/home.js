import { ArrowRight, BookOpen, Calendar, GraduationCap, PlusCircle, UserPlus, Users, } from "lucide-react";
...
function HomePage() {
    ...
    return (<div className="flex flex-col gap-6 px-4 py-2 md:gap-8 md:px-6">
      <Helmet>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat, i) => (<Card key={i} className="overflow-hidden border-none shadow-sm ring-1 ring-border/50">
