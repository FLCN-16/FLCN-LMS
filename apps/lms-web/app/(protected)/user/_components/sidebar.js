import { Book01Icon, Bookmark02Icon, LibraryIcon, Settings05Icon, TransactionHistoryIcon, } from "@hugeicons/core-free-icons";
...
function UserSidebar({ ...props }) {
    ...
    return (<Sidebar id="user-sidebar" collapsible="icon" {...props}>
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent className="flex flex-col gap-2">
            <SidebarMenu>
              {menuItems.map((item) => (<SidebarMenuItem key={item.title} className="flex items-center gap-2">
