...
describe('ApiKeysController', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            ...
            providers: [
                {
                    provide: api_keys_service_1.ApiKeysService,
    ...
    describe('findAll', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.findAll('', undefined, undefined)).rejects.toThrow(common_1.BadRequestException);
        });
        it('should throw BadRequestException if pagination is invalid', async () => {
            await expect(controller.findAll('inst-123', '0', '10')).rejects.toThrow(common_1.BadRequestException);
        });
        it('should throw BadRequestException if limit exceeds 100', async () => {
            await expect(controller.findAll('inst-123', '1', '101')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('findOne', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.findOne('key-123', '')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('update', () => {
        it('should update a key', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(service.update).toHaveBeenCalledWith(instituteId, keyId, updateDto);
        });
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.update('key-123', '', { name: 'Updated' })).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('disable', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.disable('key-123', '')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('enable', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.enable('key-123', '')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('delete', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.delete('key-123', '')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('getStats', () => {
        ...
        it('should throw BadRequestException if instituteId is missing', async () => {
            await expect(controller.getStats('key-123', '')).rejects.toThrow(common_1.BadRequestException);
        });
    });
    describe('validate', () => {
