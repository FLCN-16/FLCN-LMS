...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbSeparator, } from "@flcn-lms/ui/components/breadcrumb";
function CourseDetailBreadcrumb() {
    return (<Breadcrumb className="bg-transparent py-2">
