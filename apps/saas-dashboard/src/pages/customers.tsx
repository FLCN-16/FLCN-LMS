                ...
                >
                  <TableCell className="font-semibold text-foreground">
                    <Link
                      ...
                      className="text-cyan-600 dark:text-cyan-400 hover:underline transition-colors duration-150"
                    >
                      {customer.name}
                    </Link>
                  </TableCell>
                  ...
                  <TableCell className="text-right" onClick={(e) => e.stopPropagation()}>
                    <Button
                      ...
                      size="sm"
                      asChild
                      className="transition-colors duration-150 hover:bg-cyan-500/10"
                    >
