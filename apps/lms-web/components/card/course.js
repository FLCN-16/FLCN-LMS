...
function CourseCard({ id, title, slug, price, discountPrice, imageUrl, }) {
    return (<div className={cn("flex max-w-84 flex-col rounded-lg border p-2", "transition-transform duration-200 hover:scale-105")}>
      <AspectRatio ratio={320 / 180} className="pointer-events-none mb-2 overflow-hidden rounded-md">
