...
function AuthLogin() {
    return (<div className="grid min-h-svh lg:grid-cols-6">
      <div className="relative hidden bg-muted lg:col-span-4 lg:block">
        <Image src="/placeholder.svg" alt="Image" className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale" fill/>
      </div>
