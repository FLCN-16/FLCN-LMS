...
import { NavigationMenu, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, navigationMenuTriggerStyle, } from "@flcn-lms/ui/components/navigation-menu";
        ...
        <nav className="hidden items-center md:flex">
          <NavigationMenu>
            <NavigationMenuList className="gap-x-4">
              {navLinks.map((link) => (<NavigationMenuItem key={link.href}>
