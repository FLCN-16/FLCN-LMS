      ...
      ? {
          ...
          features: Array.isArray(plan.features)
            ...
            : typeof plan.features === "object" && plan.features !== null
              ? Object.entries(plan.features).map(([name, value]: [string, any]) => ({
                  name,
  ...
  const onSubmit = async (data: PlanFormData) => {
    try {
      const submitData = {
        ...
        features: data.features?.reduce((acc: Record<string, any>, feature) => {
          acc[feature.name] = {
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        placeholder="99.99"
                        className={`h-11 text-base ${
                          errors.priceMonthly ? "border-destructive focus-visible:ring-destructive" : ""
                        }`}
                        disabled={isSubmitting}
                      />
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        placeholder="999.99"
                        className={`h-11 text-base ${
                          errors.priceYearly ? "border-destructive focus-visible:ring-destructive" : ""
                        }`}
                        disabled={isSubmitting}
                      />
                    )}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => append({ name: "", enabled: true, description: "" })}
                    disabled={isSubmitting}
                    className="gap-2"
                  >
                            ...
                            <Controller
                              ...
                              render={({ field }) => (
                                <Input
                                  ...
                                  placeholder="e.g., Live Sessions, Advanced Analytics"
                          ...
                          <div className="space-y-2">
                            ...
                            <Controller
                              ...
                              render={({ field }) => (
                                <Input
                                  {...field}
                                  id={`features.${index}.limit`}
                                  type="number"
                                  placeholder="e.g., 100 users, unlimited"
                                  className="h-9 text-sm"
                                  disabled={isSubmitting}
                                />
                              )}
