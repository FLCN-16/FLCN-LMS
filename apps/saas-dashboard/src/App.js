    ...
    return (<BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<ProtectedDashboardLayout />}>
          ...
          <Route path="super-admins" element={withPermission(<SuperAdminsPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="customers" element={withPermission(<CustomersPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="plans" element={withPermission(<PlansPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="licenses" element={withPermission(<LicensesPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="subscriptions" element={withPermission(<SubscriptionsPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="api-keys" element={withPermission(<ApiKeysPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="billing" element={withPermission(<BillingPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="invoices" element={withPermission(<InvoicesPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
          <Route path="refunds" element={withPermission(<RefundsPage />, {
            action: "read",
            subject: "Dashboard",
        })}/>
