...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, } from "@flcn-lms/ui/components/accordion";
...
async function CourseDetailSupport() {
    return (<section id="course-detail-support" className="py-12">
          ...
          <div>
            <Card>
              ...
              <CardContent className="space-y-3">
                <a href="mailto:support@flcnlms.com" className="block text-sm text-primary hover:underline">
