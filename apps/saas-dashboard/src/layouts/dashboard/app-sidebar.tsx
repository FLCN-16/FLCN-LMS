import { GlobalEducationIcon, Settings02Icon } from "@hugeicons/core-free-icons"
      ...
      <SidebarHeader className="border-b border-border/50 bg-gradient-to-b from-background to-background/50">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              className="transition-colors duration-200 hover:bg-accent/50 data-[slot=sidebar-menu-button]:p-1.5!"
            >
