...
export function RichEditor({
  ...
  return (
    <div className={cn("overflow-hidden rounded-md border border-input", className)}>
      ...
      <div
        ref={toolbarRef}
        className="border-b border-input bg-muted/40 [&_.ql-formats]:mr-2"
        dangerouslySetInnerHTML={{ __html: buildToolbarHTML(mode) }}
      />
...
function buildToolbarHTML(mode: "full" | "basic"): string {
  if (mode === "basic") {
    return `
