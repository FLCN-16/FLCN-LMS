...
let UpdateSuperAdminDto = (() => {
    let _classSuper = (0, mapped_types_1.PartialType)(create_super_admin_dto_1.CreateSuperAdminDto);
    let _isActive_decorators;
    let _isActive_initializers = [];
    let _isActive_extraInitializers = [];
    return class UpdateSuperAdminDto extends _classSuper {
        static {
