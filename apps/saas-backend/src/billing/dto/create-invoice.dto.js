...
exports.InvoiceStatsDto = exports.InvoiceResponseDto = exports.UpdateInvoiceDto = exports.CreateInvoiceDto = exports.LineItemDto = void 0;
...
let LineItemDto = (() => {
    ...
    return class LineItemDto {
        ...
        quantity = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _quantity_initializers, 1));
...
let CreateInvoiceDto = (() => {
    ...
    return class CreateInvoiceDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _billingId_decorators = [(0, class_validator_1.IsUUID)(), (0, class_validator_1.IsNotEmpty)()];
            _stripeInvoiceId_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _invoiceNumber_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _invoiceDate_decorators = [(0, class_validator_1.IsDate)(), (0, class_transformer_1.Type)(() => Date), (0, class_validator_1.IsNotEmpty)()];
            _periodStart_decorators = [(0, class_validator_1.IsDate)(), (0, class_transformer_1.Type)(() => Date), (0, class_validator_1.IsNotEmpty)()];
            _periodEnd_decorators = [(0, class_validator_1.IsDate)(), (0, class_transformer_1.Type)(() => Date), (0, class_validator_1.IsNotEmpty)()];
            _lineItems_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(() => LineItemDto), (0, class_validator_1.IsOptional)()];
        ...
        billingId = __runInitializers(this, _billingId_initializers, void 0);
...
exports.InvoiceStatsDto = InvoiceStatsDto;
