...
export default function AnalyticsOverviewPage() {
    return (<PanelPlaceholderPage title="Analytics Overview" description="Executive view of learning, revenue, and engagement signals across the admin panel." tasks={[
