...
export default function ContentReviewPage() {
    return (<PanelPlaceholderPage title="Content Review" description="Quality-control area for reviewing course, question, and live-session content before release." tasks={[
