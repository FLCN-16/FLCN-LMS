...
export function TestForm({
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    onSubmit({
      ...
      testType: fd.get("testType") as TestType,
      ...
      showResultAfter: (fd.get("showResultAfter") as ResultMode) || undefined,
    })
  }
          ...
          <FieldGroup>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field>
                ...
                <Input
                  ...
                  type="number"
                  min="1"
                  defaultValue={defaultValues?.order ?? nextOrder}
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field>
                ...
                <NativeSelect
                  name="testType"
                  defaultValue={defaultValues?.testType ?? "FULL_LENGTH"}
                  className="w-full"
                >
                  {Object.entries(TEST_TYPE_LABELS).map(([val, label]) => (
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Field>
                ...
                <Input
                  ...
                  min="1"
                  required
                  defaultValue={defaultValues?.totalMarks ?? 300}
                />
              </Field>
              ...
              <Field>
                ...
                <Input
                  ...
                  min="1"
                  required
                  defaultValue={defaultValues?.totalQuestions ?? 75}
                />
              </Field>
            </div>
          ...
          <FieldGroup>
            <div className="grid grid-cols-2 gap-4">
              <DateTimePicker
                ...
                description="Leave empty to make available immediately"
              />
              <DateTimePicker
                name="endsAt"
                label="Ends At"
                ...
                description="Auto-submits attempts after this time"
              />
            </div>
          </FieldGroup>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="pt-4">
          <Field>
            <RichEditor
              name="instructions"
              placeholder="Instructions shown to students on the test start screen…"
