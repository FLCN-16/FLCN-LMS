...
export const siteConfig = {
    ...
    description: "Isomorphic is the ultimate React TypeScript Admin Template. Streamline your admin dashboard development with a feature-rich, responsive, and highly customizable solution.",
    url: "https://isomorphic-furyroad.vercel.app",
    ogImage: "https://s3.amazonaws.com/redqteam.com/isomorphic-furyroad/itemdep/isobanner.png",
    logo: logoImg,
    icon: logoIconImg,
    mode: "light",
    locale: "en_US",
...
const metaObject = ({ title, description = siteConfig.description, openGraph, noIndex = false, canonicalUrl, } = {}) => {
