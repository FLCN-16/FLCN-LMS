...
export default function CourseReportsPage() {
    return (<PanelPlaceholderPage title="Course Reports" description="Course-level reporting workspace for performance, consumption, and completion insights." tasks={[
