...
let UpdateBillingDto = (() => {
    let _classSuper = (0, mapped_types_1.PartialType)(create_billing_dto_1.CreateBillingDto);
    let _status_decorators;
    let _status_initializers = [];
    let _status_extraInitializers = [];
    return class UpdateBillingDto extends _classSuper {
        static {
