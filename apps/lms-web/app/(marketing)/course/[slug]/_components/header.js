...
function CourseDetailHeader() {
    return (<section id="course-detail-header" className="relative mb-18 bg-gray-100 py-12 pb-26 dark:bg-black">
      ...
      <div className={cn("absolute right-0 bottom-0 left-0 container grid translate-y-1/2 transform grid-cols-4 overflow-hidden rounded bg-primary-foreground p-8 shadow-lg")}>
